...
{{PLUGIN_NAME}} is a Claude Code plugin that provides [describe your plugin's main capability here]. It helps users [describe the primary use case].
...
| Agent | Description |
|-------|-------------|
| `{{PLUGIN_NAME}}-example-agent` | An example agent -- replace with your actual agents |
