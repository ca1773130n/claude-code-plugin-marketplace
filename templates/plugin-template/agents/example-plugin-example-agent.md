---
name: example-plugin-example-agent
description: An example agent that demonstrates the agent file format for {{PLUGIN_NAME}}. Replace this with your actual agent definition.
tools: Read, Write, Edit, Bash, Grep, Glob
---

<role>
You are an example agent for the {{PLUGIN_NAME}} plugin. This file demonstrates the standard agent definition format used by Claude Code plugins.
